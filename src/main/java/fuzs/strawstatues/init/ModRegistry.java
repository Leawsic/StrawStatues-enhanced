...
public class ModRegistry {
    ...
    // Expanded arm ranges: X extended from (-180,0) to (-180,45) allowing some forward rotation
    public static final PosePartMutator RIGHT_ARM_POSE_MUTATOR = new PosePartMutator("rightArm", ArmorStandPose::getRightArmPose, ArmorStandPose::withRightArmPose, PosePartMutator.PosePartAxisRange.range(-180.0F, 45.0F), PosePartMutator.PosePartAxisRange.range(-90.0F, 45.0F), PosePartMutator.PosePartAxisRange.range(-120.0F, 120.0F));
    public static final PosePartMutator LEFT_ARM_POSE_MUTATOR = new PosePartMutator("leftArm", ArmorStandPose::getLeftArmPose, ArmorStandPose::withLeftArmPose, PosePartMutator.PosePartAxisRange.range(-180.0F, 45.0F), PosePartMutator.PosePartAxisRange.range(-45.0F, 90.0F), PosePartMutator.PosePartAxisRange.range(-120.0F, 120.0F));
